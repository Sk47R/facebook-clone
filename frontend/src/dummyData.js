...
export const Posts = [
  {
    id: 1,
    description:
      "Real Life Shawshank Redemption: Janmakaid jail sajaye payeka 47 years male karagar (कारागार) ma Surung (सुरुङ) khanera bhageko 21 yrs pachi balla hijo Surkhet Police le arrest gareko cha.",
